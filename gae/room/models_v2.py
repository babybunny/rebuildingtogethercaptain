...
class Staff(ndb.Model):
  ...
  program_selected_key = ndb.KeyProperty(kind=Program, required=True)
...
class Site(ndb.Model):
  ...
  program = ndb.KeyProperty(kind=Program, required=True)  # reference
...
class Order(ndb.Model):
  ...
  program = ndb.KeyProperty(kind=Program, required=True)
