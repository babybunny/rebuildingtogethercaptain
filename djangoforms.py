  ...
  def __new__(cls, class_name, bases, attrs):
    ...
    if opts.model is not None:
      ...
      for name, field in model_fields.iteritems():
        prop = props.get(name)
        if prop:
          # See django.forms.forms.BaseForm.full_clean for its special 
          # handling of FileField, which is emulated here, and also
          # django.forms.fields.FileField's clean() method.
