...
def CreateAll():
  ...
  KEYS['CAPTAIN'] = models_v2.Captain(
    name="Miss Captain",
  ...
  KEYS['PROGRAM'] = models_v2.Program(
    year=2011,
    name="TEST",
    site_number_prefix="110",
    status="Active"
  ).put()
  KEYS['PROGRAM2'] = models_v2.Program(
    year=2012,
    name="TEST",
  ...
  KEYS['JURISDICTION'] = models_v2.Jurisdiction(
    name="FunkyTown"
  ).put()
  KEYS['JURISDICTION2'] = models_v2.Jurisdiction(
    name="Unicorn Town"
  ).put()

  KEYS['SUPPLIER'] = models_v2.Supplier(
  ...
  KEYS['SUPPLIER2'] = models_v2.Supplier(
  ...
  KEYS['STAFF'] = models_v2.Staff(
    name="Mister Staff",
    email="rebuildingtogether.staff@gmail.com",
    last_welcome=datetime.datetime(2017, 1, 30, 1, 2, 3),
    program_selected=KEYS['PROGRAM'],
  ).put()
  KEYS['STAFF2'] = models_v2.Staff(
    name="Mister Staff",
    email="rebuildingtogether.staff2@gmail.com",
    program_selected=KEYS['PROGRAM2']
  ).put()

  KEYS['SITECAPTAIN'] = models_v2.SiteCaptain(
    site=KEYS['SITE'],
    captain=KEYS['CAPTAIN'],
    type='Construction'
  ).put()

  KEYS['STAFFTIME'] = models_v2.StaffTime(
    site=KEYS['SITE'],
    captain=KEYS['CAPTAIN'],
  ...
  KEYS['STAFFTIME2'] = models_v2.StaffTime(
    site=KEYS['SITE'],
    # captain=None,
    # position=None,
    program=KEYS['PROGRAM2'],
    state='new',
    hours=0,
    miles=0,
    activity_date=datetime.datetime(2017, 1, 30, 1, 2, 3),
  ...
  KEYS['CHECKREQUEST'] = models_v2.CheckRequest(
    site=KEYS['SITE'],
    captain=KEYS['CAPTAIN'],
    program=KEYS['PROGRAM'],
  ...
  KEYS['CHECKREQUEST2'] = models_v2.CheckRequest(
    site=KEYS['SITE'],
    state='new',
  ).put()

  KEYS['VENDORRECEIPT'] = models_v2.VendorReceipt(
    site=KEYS['SITE'],
    captain=KEYS['CAPTAIN'],
    program=KEYS['PROGRAM'],
  ...
  KEYS['INKINDDONATION'] = models_v2.InKindDonation(
    site=KEYS['SITE'],
    captain=KEYS['CAPTAIN'],
    program=KEYS['PROGRAM'],
  ...
  KEYS['ORDERSHEET'] = models_v2.OrderSheet(
  ...
  KEYS['ORDERSHEET2'] = models_v2.OrderSheet(
    # no default_supplier
  ...
  KEYS['ORDERSHEET3'] = models_v2.OrderSheet(
    # no default_supplier
    name='Debris Box',
    code='DEB',
  ...
  KEYS['ORDERSHEET4'] = models_v2.OrderSheet(
    # no default_supplier
    name='VOID',
    code='VOI',
  ...
  KEYS['ORDERSHEET5'] = models_v2.OrderSheet(
    # no default_supplier
  ...
  KEYS['INVENTORYITEM'] = models_v2.InventoryItem(
    item=KEYS['ITEM'],
    quantity=0,
    quantity_float=0.0,
  ...
  KEYS['INVOICENUMBER'] = models_v2.InvoiceNumber(
    id='global',
    next_invoice_number=10000
  ).put()

  KEYS['ORDER'] = models_v2.Order(
    site=KEYS['SITE'],
  ...
  KEYS['DELIVERY'] = models_v2.Delivery(
    site=KEYS['SITE'],
  ...
  KEYS['ORDERDELIVERY'] = models_v2.OrderDelivery(
    order=KEYS['ORDER'],
    delivery=KEYS['DELIVERY'],
  ).put()

  KEYS['PICKUP'] = models_v2.Pickup(
    site=KEYS['SITE'],
    pickup_date='Apr 13',
    return_date='Apr 19',
    contact='Joe Pickup',
  ...
  KEYS['ORDERPICKUP'] = models_v2.OrderPickup(
    order=KEYS['ORDER'],
    pickup=KEYS['PICKUP'],
  ).put()

  KEYS['RETRIEVAL'] = models_v2.Retrieval(
    site=KEYS['SITE'],
    dropoff_date='Apr 14',
  ...
  KEYS['ORDERRETRIEVAL'] = models_v2.OrderRetrieval(
    order=KEYS['ORDER'],
    retrieval=KEYS['RETRIEVAL'],
  ).put()

  KEYS['ORDERITEM'] = models_v2.OrderItem(
    order=KEYS['ORDER'],
    item=KEYS['ITEM'],
    supplier=KEYS['SUPPLIER'],
    quantity_float=1.1,
  ...
  KEYS['ORDERITEM2'] = models_v2.OrderItem(
    order=KEYS['ORDER'],
    item=KEYS['ITEM2'],
    supplier=KEYS['SUPPLIER'],
    quantity_float=2.0,
  ...
  KEYS['ORDERITEM4'] = models_v2.OrderItem(
    order=KEYS['ORDER'],
    item=KEYS['ITEM4'],
    supplier=KEYS['SUPPLIER'],
    quantity_float=1.0,
